...
public class UserInterfaceController implements Initializable {
    ...
    private void setChosenCoffee(Coffee coffee) {
        ...
        String imagePath = "file:///D:/Nam 3/Ki_1/Sofware Testing (Verification & Validation) CMU-303 OIS/CoffeeShopSystemManagement/src/User/resources/img/" + coffee.getImgSrc().replace("&", "&amp;");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            for (int i = 0; i < coffees.size(); i++) {
                ...
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/User/item.fxml"));
